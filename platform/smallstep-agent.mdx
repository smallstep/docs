...
Stable, unversioned URLs that always point at the latest release on the `stable` channel:
...
For versioned artifacts — with SHA-256 and signature-verification commands — see [releases.smallstep.com](https://releases.smallstep.com).
