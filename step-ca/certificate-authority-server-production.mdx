...
or let [`step ca init`](../step-cli/reference/ca/init.mdx) generate a strong password for you.
...
The Root CA certificate is generated once, when you run [`step ca init`](../step-cli/reference/ca/init.mdx).
...
The Intermediate CA certificate is generated once, when you run [`step ca init`](../step-cli/reference/ca/init.mdx). It is signed by the Root CA certificate.
