...
In the project of your choosing, first [create a Cloud KMS key ring](https://cloud.google.com/kms/docs/create-key-ring) called `step-ca`.

Next, let's generate a private key for your Root CA. Run:
