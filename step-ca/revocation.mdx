...
<Alert severity="info">
  ...
  <div>
	...
	If you're sure you need it, our <a href="https://smallstep.com/signup?product=cm">Certificate Manager Advanced Authority</a> service supports active revocation.
  </div>
</Alert>
...
<Alert severity="info">
  <div>
    ...
    alternative, you can use our hosted CA, <a
    href="https://smallstep.com/certificate-manager">Smallstep Certificate Manager</a>.
  </div>
</Alert>
