...
Before revoking the certificate, note that it can be renewed with [`step ca renew`](../step-cli/reference/ca/renew.mdx).
...
- [Enable active revocation on your intermediate CA](../step-ca/certificate-authority-server-production/.mdx#enable-active-revocation-on-your-intermediate-ca)
