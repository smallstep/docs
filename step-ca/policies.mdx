...
html_title: Certificate Authority Policy Engine Reference
description: Define certificate issuance policies in step-ca. Enforce security rules and compliance requirements for PKI operations at scale effectively.
---
...
- A single IP rule (for example, `192.168.0.30`, `::1`) will match exactly that IP address.
- A CIDR rule (for example, `192.168.0.0/24`, `2001:0db8:85a3::8a2e:0370:7334/120`) matches all IP addresses included in the range.
