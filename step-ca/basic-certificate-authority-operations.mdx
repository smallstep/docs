...
description: Learn basic certificate authority operations in Smallstep. Read docs today and simplify enterprise PKI management with automated workflows.
---
...
You cannot "un-issue" a certificate. Once a certificate has been signed and distributed by the CA, it's valid until it expires.
...
- No certificate chains exist in SSH.
