...
You will need [`step`](../step-cli.mdx) and [`step-ca`](../step-ca.mdx) installed on your system.
...
Run the command [`step ca init`](../step-cli/reference/ca/init.mdx) in a terminal to configure your CA. You'll be asked about your project, DNS setup, etc.

The [`step ca init`](../step-cli/reference/ca/init.mdx) command has a lot of flags.
...
* Pass `--acme` to create an [ACME provisioner](../step-ca/provisioners/#acme)
* Pass `--remote-management` to enable [Remote Provisioner Management](../step-ca/provisioners/#remote-provisioner-management)
...
You can use [`step ca`](../step-cli/reference/ca.mdx) and [`step ssh`](../step-cli/reference/ssh.mdx) command groups to interact with the CA. See [Basic CA Operations](../step-ca/basic-certificate-authority-operations.mdx) for an overview of common operations.

#### Accessing your CA remotely

To access your CA remotely, install and use the [`step`](../step-cli.mdx) command on clients.
...
You can do this by supplying your CA fingerprint to [`step ca bootstrap`](../step-cli/reference/ca/bootstrap.mdx).
...
You may also wish to establish system-wide trust of your CA, so your certificates will be trusted by `curl` and other programs. Use the [`step certificate install`](../step-cli/reference/certificate/install.mdx) command to install your root CA certificate into your system's trust store:
...
If you already ran [`step certificate install`](../step-cli/reference/certificate/install.mdx) to install your root CA into your system's trust store, this command will work and you'll see "Hello, World!".
...
* Or, head straight to our [tutorials](../tutorials.mdx) to see more examples of using `step-ca` in the wild.
