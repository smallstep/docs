...
<Alert severity="info">
  ...
  <div>
    ...
    <Link href="https://github.com/smallstep/certificates/blob/master/CONTRIBUTING.md">getting
...
<Alert severity="info">
  ...
  <div>
    The <Link href="https://smallstep.com/docs/step-cli"><Code>step</Code> CLI tool</Link> is the easiest way to
