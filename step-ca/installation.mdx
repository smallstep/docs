...
<Alert severity="info">
    ...
    <div>
      To install, append <code>http://dl-cdn.alpinelinux.org/alpine/edge/testing</code> to <code>/etc/apk/repositories</code>,
     or see <a href="#linux-binaries">Linux (other)</a>.
    </div>
</Alert>
<br>
