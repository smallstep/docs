...
[Sprig functions](http://masterminds.github.io/sprig/) are availabie inside the templates.
...
3. `asn1Seq` gets the resulting Base64 strings, decodes them, creates an ASN.1 SEQENCE, and returns the Base64 of the SEQUENCE.
