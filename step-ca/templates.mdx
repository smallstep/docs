...
This template example does the following:

1. `asn1Enc "YubiKey"` encodes "YubiKey" as an ASN.1 Printable string, and return the base64
2. `asn1Enc "int:123456"` encodes 123 as an ASN.1 Integer, and return the base64
3. `asn1Seq` gets the resulting base64 strings, decodes them, creates an ASN.1 SEQENCE and return the base64 of the SEQUENCE.
...
It supports the data types described in [this function](https://github.com/smallstep/crypto/blob/878092791d7e5ef8530dfa949cfe3cde61373d77/x509util/extensions.go#L486):
