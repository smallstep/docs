...
html_title: Basic Cryptographic Operations Complete Guide
description: Perform essential cryptographic operations using step CLI. Generate keys, create certificates, and manage secure communications.
---
...
<Aside>
<p>To get TLS working from here, you'll need to do two things:</p>
<ul>
