...
Let's take a look at the [`step certificate`](../step-cli/reference/certificate/.mdx) command group.
...
You can get a certificate in JSON format by calling [`step certificate inspect`](../step-cli/reference/certificate/inspect.mdx) with `--format json`. This example [uses jq](https://stedolan.github.io/jq/) to parse the JSON and extract a specific value:
...
* [`step crypto jwt`](../step-cli/reference/crypto/jwt.mdx)
* [`step crypto jwk`](../step-cli/reference/crypto/jwk.mdx)
* [`step crypto jwe`](../step-cli/reference/crypto/jwe.mdx)
* [`step crypto jws`](../step-cli/reference/crypto/jws.mdx)
* [`step crypto jose`](../step-cli/reference/crypto/jose.mdx)
...
The [`step oauth`](../step-cli/reference/oauth/.mdx) command group supports API authorization and single sign on with OAuth and OIDC.
...
With [`step crypto otp`](../step-cli/reference/crypto/otp.mdx), you can generate a [TOTP](https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm) token and a QR code:
...
You can use the [`step crypto nacl`](../step-cli/reference/crypto/nacl.mdx) command group to sign or encrypt arbitrary data for internal use. This command group uses the [NaCl library](https://nacl.cr.yp.to/)'s high-speed crypto primitives.

### Work with SSH Certificates

The [`step ssh`](../step-cli/reference/ssh/.mdx) command group is usually used in conjunction with `step-ca`'s SSH CA functionality. But not all the subcommands require an SSH CA. You can inspect an SSH certificate:
