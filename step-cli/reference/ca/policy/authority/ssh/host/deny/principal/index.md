...
layout: auto-doc
category: reference
title: step ca policy authority ssh host deny principal
menu:
  docs:
...
## Name
**step ca policy authority ssh host deny principal** -- add or remove principals

## Usage

```raw
step ca policy authority ssh host deny principal <principal> [--remove] [--provisioner=<name>]
...
**step ca policy authority ssh host deny principal** command manages principals in SSH policies
