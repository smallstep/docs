...
layout: auto-doc
category: reference
title: step ca policy authority ssh user deny email
menu:
  docs:
...
## Name
**step ca policy authority ssh user deny email** -- add or remove email addresses

## Usage

```raw
step ca policy authority ssh user deny email <email> [--remove] [--provisioner=<name>]
...
**step ca policy authority ssh user deny email** command manages email addresses and domains in policies
