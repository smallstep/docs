...
layout: auto-doc
category: reference
title: step ca policy authority view
menu:
  docs:
...
## Name
**step ca policy authority view** -- view current certificate issuance policy
...
**step ca policy authority view** shows the currently configured policy.
