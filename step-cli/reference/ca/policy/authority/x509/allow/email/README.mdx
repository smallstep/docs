...
layout: auto-doc
category: reference
title: step ca policy authority x509 allow email
menu:
  docs:
...
## Name
**step ca policy authority x509 allow email** -- add or remove email addresses

## Usage

```raw
step ca policy authority x509 allow email <email> [--remove] [--provisioner=<name>]
...
**step ca policy authority x509 allow email** command manages email addresses and domains in policies
