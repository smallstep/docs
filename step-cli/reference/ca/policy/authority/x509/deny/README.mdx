...
```raw
step ca policy <scope> x509 deny <subcommand> [arguments] [global-flags] [subcommand-flags]
```

## Description

**step ca policy `scope` x509 deny** command group provides facilities for managing X.509 names to be denied.
