...
layout: auto-doc
category: reference
title: step ca policy authority x509 deny dns
menu:
  docs:
...
## Name
**step ca policy authority x509 deny dns** -- add or remove DNS domains

## Usage

```raw
step ca policy authority x509 deny dns <domain> [--remove]
...
**step ca policy authority x509 deny dns** command manages DNS domains in policies
