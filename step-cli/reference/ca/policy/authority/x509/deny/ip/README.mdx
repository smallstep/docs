...
layout: auto-doc
category: reference
title: step ca policy authority x509 deny ip
menu:
  docs:
...
## Name
**step ca policy authority x509 deny ip** -- add or remove ip addresses
...
**step ca policy authority x509 deny ip** command manages IP addresses and ranges in policies
