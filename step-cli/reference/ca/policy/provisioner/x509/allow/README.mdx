...
```raw
step ca policy <scope> x509 allow <subcommand> [arguments] [global-flags] [subcommand-flags]
```

## Description

**step ca policy `scope` x509 allow** command group provides facilities for managing X.509 names to be allowed.
