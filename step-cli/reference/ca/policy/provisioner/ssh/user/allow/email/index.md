...
layout: auto-doc
category: reference
title: step ca policy provisioner ssh user allow email
menu:
  docs:
...
## Name
**step ca policy provisioner ssh user allow email** -- add or remove email addresses

## Usage

```raw
step ca policy provisioner ssh user allow email <email> [--remove] [--provisioner=<name>]
...
**step ca policy provisioner ssh user allow email** command manages email addresses and domains in policies
