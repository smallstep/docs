...
layout: auto-doc
category: reference
title: step ca policy provisioner ssh host allow principal
menu:
  docs:
...
## Name
**step ca policy provisioner ssh host allow principal** -- add or remove principals

## Usage

```raw
step ca policy provisioner ssh host allow principal <principal> [--remove] [--provisioner=<name>]
...
**step ca policy provisioner ssh host allow principal** command manages principals in SSH policies
