...
layout: auto-doc
category: reference
title: step ca policy provisioner ssh host deny email
menu:
  docs:
...
## Name
**step ca policy provisioner ssh host deny email** -- add or remove email addresses

## Usage

```raw
step ca policy provisioner ssh host deny email <email> [--remove] [--provisioner=<name>]
...
**step ca policy provisioner ssh host deny email** command manages email addresses and domains in policies
