...
layout: auto-doc
category: reference
title: step ca policy acme view
menu:
  docs:
...
## Name
**step ca policy acme view** -- view current certificate issuance policy

## Usage

```raw
step ca policy acme view
...
**step ca policy acme view** shows the currently configured policy.
