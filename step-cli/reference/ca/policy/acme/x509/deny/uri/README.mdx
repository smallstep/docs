...
layout: auto-doc
category: reference
title: step ca policy acme x509 deny uri
menu:
  docs:
...
## Name
**step ca policy acme x509 deny uri** -- add or remove URI domains

## Usage

```raw
step ca policy acme x509 deny uri <uri domain> [--remove] [--provisioner=<name>]
...
**step ca policy acme x509 deny uri** command manages URI domains in policies
