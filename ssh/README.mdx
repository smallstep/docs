...
<Alert severity="info" mb={4}>
  <div>
    ...
    <Link href="/docs/step-ca">Find it here</Link>.
  </div>
</Alert>
...
<Alert severity="info" mt={2}>
  ...
  <div>
    ...
    <Link href="mailto:support@smallstep.com">contact us</Link> and tell us a
...
[how it works page](/sso-ssh/how-it-works). Learn how we protect your data, see
