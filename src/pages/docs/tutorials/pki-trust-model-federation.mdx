...
- **[Smallstep Certificate Manager](/certificate-manager) -** Please get in touch with [Smallstep](mailto:cs@smallstep.com) if you want to federate an existing Root with a Certificate Manager Authority.
