...
provisioner name to [`step ca certificate`](/docs/step-cli/reference/ca/certificate) with the `--provisioner` attribute,
...
The first positional argument to [`step ca certificate`](/docs/step-cli/reference/ca/certificate) specifies our workload's
...
We can use [`step certificate inspect`](/docs/step-cli/reference/certificate/inspect) to check our work:
