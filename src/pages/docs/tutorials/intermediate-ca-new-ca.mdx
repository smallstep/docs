...
- **[Smallstep Certificate Manager](/certificate-manager) -** Please contact [Smallstep Customer Success](/request-demo) and we will assist in creating your intermediate authority off an existing Root. 
