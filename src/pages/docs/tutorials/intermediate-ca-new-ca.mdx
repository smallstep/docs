...
- **[Smallstep Certificate Manager](/certificate-manager) -** Please contact [Smallstep Customer Success](mailto:cs@smallstep.com) and we will assist in creating your intermediate authority off an existing Root. 
