...
- **[Smallstep Certificate Manager](/certificate-manager) -** Please visit the [OIDC documentation](/docs/certificate-manager/oidc) instead of using this tutorial to connect your identity provider to Certificate Manager.
