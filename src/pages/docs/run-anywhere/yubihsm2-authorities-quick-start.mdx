---
title: YubiHSM2 Authorities Quick Start
html_title: YubiHSM2 Authorities Quick Start
description: Learn how to configure a YubiHSM2 for your run anywhere deployment
---


Depending on your organization's requirements, you may opt to use a YubiHSM2 as a hardware-backed, local key storage solution instead of using other conventional KMS options. This guide will walk you through setup of your YubiHSM2 devices to assure that they will be compatible with your `run anywhere` deployment.
