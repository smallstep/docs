...
See the [`step ca admin list` command reference](https://smallstep.com/docs/step-cli/reference/beta/ca/admin/list) for additional flags.
...
See the [`step ca admin add` command reference](https://smallstep.com/docs/step-cli/reference/beta/ca/admin/add) for additional flags.

You can also [update](https://smallstep.com/docs/step-cli/reference/beta/ca/admin/update) or [remove](https://smallstep.com/docs/step-cli/reference/beta/ca/admin/remove) admins with the `step ca admin` command group.
...
Check the existing configuration for a given provisioner by running [`step ca provisioner get`](https://smallstep.com/docs/step-cli/reference/beta/ca/provisioner/get):
...
> Our open source documentation was written for `step-ca`, so it instructs you to use the `step ca` commands instead of the `step` commands. Instead, use the `step` commands listed in the guide above.
