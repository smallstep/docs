...
```shell
curl.exe -LO https://dl.step.sm/gh-release/cli/docs-cli-install/v0.18.0/step_windows_0.18.0_amd64.zip
Expand-Archive -LiteralPath .\step_windows_0.18.0_amd64.zip -DestinationPath .
step_0.18.0\bin\step.exe version
```
