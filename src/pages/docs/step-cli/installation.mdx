...
```shell
curl.exe -LO https://dl.step.sm/gh-release/cli/docs-cli-install/v0.20.0/step_windows_0.20.0_amd64.zip
Expand-Archive -LiteralPath .\step_windows_0.20.0_amd64.zip -DestinationPath .
step_0.20.0\bin\step.exe version
```
