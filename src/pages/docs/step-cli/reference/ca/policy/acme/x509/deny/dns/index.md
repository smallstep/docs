---
layout: auto-doc
title: step ca policy acme x509 deny dns
menu:
  docs:
...
## Name
**step ca policy acme x509 deny dns** -- add or remove DNS domains

## Usage

```raw
step ca policy acme x509 deny dns <domain> [--remove]
...
**step ca policy acme x509 deny dns** command manages DNS domains in policies
