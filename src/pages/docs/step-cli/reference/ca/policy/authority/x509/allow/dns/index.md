---
layout: auto-doc
title: step ca policy authority x509 allow dns
menu:
  docs:
...
## Name
**step ca policy authority x509 allow dns** -- add or remove DNS domains

## Usage

```raw
step ca policy authority x509 allow dns <domain> [--remove]
...
**step ca policy authority x509 allow dns** command manages DNS domains in policies
