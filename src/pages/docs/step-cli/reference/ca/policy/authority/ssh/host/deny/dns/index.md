---
layout: auto-doc
title: step ca policy authority ssh host deny dns
menu:
  docs:
...
## Name
**step ca policy authority ssh host deny dns** -- add or remove DNS domains

## Usage

```raw
step ca policy authority ssh host deny dns <domain> [--remove]
...
**step ca policy authority ssh host deny dns** command manages DNS domains in policies
