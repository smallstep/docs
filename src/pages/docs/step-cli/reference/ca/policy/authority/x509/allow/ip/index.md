...
layout: auto-doc
category: reference
title: step ca policy authority x509 allow ip
menu:
  docs:
...
## Name
**step ca policy authority x509 allow ip** -- add or remove ip addresses

## Usage

```raw
step ca policy authority x509 allow ip <ip address> [--remove]
...
**step ca policy authority x509 allow ip** command manages IP addresses and ranges in policies
