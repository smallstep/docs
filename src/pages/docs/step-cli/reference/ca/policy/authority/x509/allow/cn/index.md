---
layout: auto-doc
title: step ca policy authority x509 allow cn
menu:
  docs:
...
## Name
**step ca policy authority x509 allow cn** -- add or remove common names

## Usage

```raw
step ca policy authority x509 allow cn <name> [--remove]
...
**step ca policy authority x509 allow cn** command manages common names in policies
