...
offer regular key rotation and [passive revocation](/docs/step-ca/revocation)
...
Now let's generate a [single-use bootstrap token](/docs/cli/ca/token/) and use it to obtain a certificate:
...
See the [certificate revocation section](/docs/step-ca/revocation) for details.
