...
In `step-ca`, the Nebula provisioner will authorize certificate subjects that include the `name`, plus IP SANs for any of the CIDR blocks in the `ips` list on the Nebula certificate.
