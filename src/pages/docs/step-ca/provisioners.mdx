...
Get an X509 certificate with the Nebula provisioner, using a Nebula client certificate and key that has tne DNS name `host3.example.com` in the Name field, and two IPs:
