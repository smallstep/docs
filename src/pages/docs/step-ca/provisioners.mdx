...
In `step-ca`, the Nebula provisioner will authorize a certificate with a single SAN for the Name (an email SAN, DNS SAN, IP SAN, or URI SAN) plus any number of IP SANs, for the list of IPs.
