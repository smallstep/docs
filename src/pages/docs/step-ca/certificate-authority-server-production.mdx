...
When daemonized, [`step ca renew`](/docs/step-cli/reference/ca/init) will attempt a renewal when the certificate's lifetime is approximately two-thirds elapsed.
...
[`step ca renew`](/docs/step-cli/reference/ca/init) allows a certificate owner to extend the lifetime of a certificate before it expires.
