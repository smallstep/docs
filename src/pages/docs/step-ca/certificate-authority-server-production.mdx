...
- [Automating X.509 Certificate Renewal](#automating-x509-certificate-renewal)
...
## Automating X.509 Certificate Renewal
...
To configure renewal after expiry for a provisioner, pass the `--allow-renewal-after-expiry` flag to the [`step ca provisioner`](/docs/step-cli/reference/ca/provisioner) management commands. See [managing provisioners](/docs/step-ca/provisioners/#managing-provisioners).
