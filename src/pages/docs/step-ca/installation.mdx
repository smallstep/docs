...
1. Install `step`
    ...
    ```shell
    wget https://dl.step.sm/gh-release/cli/docs-ca-install/v0.18.1/step-cli_0.18.1_amd64.deb
...
2. Install `step-ca`
    ...
    ```shell
    wget https://dl.step.sm/gh-release/certificates/docs-ca-install/v0.18.1/step-ca_0.18.1_amd64.deb
...
1. Install `step`
    ...
    ```shell
    wget -O step.tar.gz https://dl.step.sm/gh-release/cli/docs-ca-install/v0.18.1/step_linux_0.18.1_amd64.tar.gz
    tar -xf step.tar.gz
    sudo cp step_0.18.1/bin/step /usr/bin
    ```
...
2. Install `step-ca`
    ...
    ```shell
    wget -O step-ca.tar.gz https://dl.step.sm/gh-release/certificates/docs-ca-install/v0.18.1/step-ca_linux_0.18.1_amd64.tar.gz
    tar -xf step-ca.tar.gz
    sudo cp step-ca_0.18.1/bin/step-ca /usr/bin
    ```
