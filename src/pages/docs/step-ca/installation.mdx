...
1. Install `step`
    ...
    ```shell
    wget https://dl.step.sm/gh-release/cli/docs-ca-install/v0.19.0/step-cli_0.19.0_amd64.deb
...
2. Install `step-ca`
    ...
    ```shell
    wget https://dl.step.sm/gh-release/certificates/docs-ca-install/v0.19.0/step-ca_0.19.0_amd64.deb
