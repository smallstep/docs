...
1. Install `step`
    ...
    ```shell
    wget https://dl.step.sm/gh-release/cli/docs-ca-install/v0.18.0/step-cli_0.18.0_amd64.deb
...
2. Install `step-ca`
    ...
    ```shell
    wget https://dl.step.sm/gh-release/certificates/docs-ca-install/v0.18.0/step-ca_0.18.0_amd64.deb
    sudo dpkg -i step-ca_0.18.0_amd64.deb
    ```
