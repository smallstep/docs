...
To use TLS with Kubernetes, you need certificates. 
...
At Smallstep, we’ve thought deeply about these cases and have created a series of tutorials to help you on your journey to secure Kubernetes. 
...
All you need is a little bit of YAML and a working cluster to start issuing TLS certificates to your microservices, and stop bad actors in their tracks. 
