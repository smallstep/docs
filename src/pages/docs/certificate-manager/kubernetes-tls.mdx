...
And for Kubernetes TLS, you need certificates. 
...
It turns out there are lots of things that Kubernetes TLS can mean. 
Here’s a hit list of some of the places where you can use certificates:
...
Kubernetes can be a complicated beast, and there are a lot of concepts to learn and practice before one knows what they’re doing. 
It can become even more difficult to secure this workload while wrangling the other moving pieces of your cluster. 
...
At Smallstep, we’ve thought deeply about these cases and have created a series of documents to help you navigate what can be a complex journey to secure Kubernetes. 

### It all starts with a question - “What are you looking to achieve?”

1. [**I want to connect things outside Kubernetes to things inside Kubernetes.**](/docs/certificate-manager/kubernetes-ingress-tls) 
2. [**I want to get a cert for a service running in a container or pod.**](/docs/certificate-manager/kubernetes-container-tls)
3. [**I am installing Kubernetes and need certs to secure things.**](/docs/certificate-manager/kubernetes-install)
...
All you need is a little bit of YAML and a working cluster to start issuing Kubernetes TLS certificates for your microservices and stop bad actors right their tracks. 
