...
As described in ["why you should use ACME"](/docs/certificate-manager/acme-enterprise/why-use-acme), the ACME protocol requires ACME clients to request certificates via HTTPS.
