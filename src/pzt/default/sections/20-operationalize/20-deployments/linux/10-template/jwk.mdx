We've created a `systemd`-based certificate renewal timer that works with `step`. Check out our documentation on [Renewal using systemd timers](https://smallstep.com/docs/step-ca/renewal#renewal-using-systemd-timers) for background on how these timers work.
