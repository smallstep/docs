...
of renewing the certificate, to do this we need to make sure to set a proper
`RenewBefore`. By default this value is set to 30 days, but if our certificate
lifetime is 24 hours, we can renew 8 hours before the expiration.
