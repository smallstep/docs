...
So in this scenario, delivering a TLS certificate to an Admission Controller is the same as [delivering a certificate to any other container.](../certificate-manager/kubernetes-container-tls.mdx)
