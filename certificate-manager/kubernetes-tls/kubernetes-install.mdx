...
In this scenario, delivering a TLS certificate to an Admission Controller is the same as [delivering a certificate to any other container.](./kubernetes-container-tls.mdx)
