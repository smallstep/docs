...
When connecting anything outside Kubernetes to services inside Kubernetes, we recommend securing your Ingress resources by using Smallstep Certificate Manager in combination with [`step-issuer`](https://github.com/smallstep/step-issuer) and [Kubernetes’ cert-manager](https://cert-manager.io/docs/) utility. [You can find the detailed instructions here.](../certificate-manager/kubernetes-step-issuer.mdx)
