...
### Before you begin
- This tutorial assumes you have created a Smallstep Team and a Certificate Manager Authority using the steps in [Getting Started](./getting-started.mdx) and understand [basic certificate operations](./basic-ops.mdx).
...
A TLS certificate only needs to be valid at the moment the connection is established. Therefore, a client certificate allowing access to a sensitive database might only need to be valid for five minutes, and the client can stay connected for as long as they need to complete the task at hand.
...
You can learn more about provisioners [here](./how-it-works.mdx#provisioners).
...
<Alert severity="info">
  <div>
    Need help with templates? <a href="mailto:support@smallstep.com">Contact</a> our Customer Success team.
  </div>
</Alert>

## Next Steps
- You've created your custom certificate; now it's time to explore [automating certificate renewal](../step-ca/renewal.mdx).
