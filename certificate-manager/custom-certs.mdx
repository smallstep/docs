...
### Before you begin
- This tutorial assumes you have created a Smallstep Team and a Certificate Manager Authority using the steps in [Getting Started](../certificate-manager/getting-started.mdx) and understand [basic certificate operations](../certificate-manager/basic-ops.mdx).
...
You can learn more about provisioners [here](../certificate-manager/how-it-works.mdx#provisioners). 
