...
More than a dozen [command-line flags](../step-cli/reference/ca/renew.mdx) make `step ca renew` flexible and easy to integrate into almost any operational environment.
