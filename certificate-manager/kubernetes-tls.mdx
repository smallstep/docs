...
1. [**I want to securely expose Kubernetes services outside my cluster.**](../certificate-manager/kubernetes-ingress-tls.mdx) 
2. [**I want to get a cert for a service running in a container or pod.**](../certificate-manager/kubernetes-container-tls.mdx)
3. [**I am bringing up a cluster and I need certs to secure Kubernetes itself.**](../certificate-manager/kubernetes-install.mdx)
