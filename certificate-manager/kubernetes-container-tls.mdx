...
1. **I trust my backing datastore and want to use TLS secrets** - we recommend using Smallstep Certificate Manager in combination with step-issuer and the [Kubernetes cert-manager](https://cert-manager.io/docs/) utility. [You can find the detailed instructions here.](../certificate-manager/kubernetes-step-issuer.mdx)
2. **I want to deliver certs directly to the container** - we recommend using Smallstep Certificate Manager in combination with Autocert. [You can find detailed instructions here.](../certificate-manager/kubernetes-autocert.mdx) 
