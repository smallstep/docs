...
3. Configure your ACME clients and issue certificates. [Find Yours >](../../tutorials/acme-protocol-acme-clients.mdx) 
...
* Issue hardware-bound certificates for device identity with [ACME device attestation](https://smallstep.com/platform/acme-device-attestation/), using the `device-attest-01` challenge.
