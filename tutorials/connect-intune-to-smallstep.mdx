...
**Note:** If you're not using Intune or need to install the agent manually or via scripts, see the [Smallstep Agent Manual Installation](../platform/smallstep-agent.mdx#windows-installation) guide.
