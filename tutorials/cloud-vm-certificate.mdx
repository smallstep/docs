...
provisioner name to [`step ca certificate`](../step-cli/reference/ca/certificate.mdx) with the `--provisioner` attribute,
...
The first positional argument to [`step ca certificate`](../step-cli/reference/ca/certificate.mdx) specifies our workload's
...
We can use [`step certificate inspect`](../step-cli/reference/certificate/inspect.mdx) to check our work:
