---
title: Try EAP-TLS Wi-Fi on Apple devices without an MDM
html_title: Try EAP-TLS Wi-Fi on Apple devices without an MDM
description: This tutorial focuses on a simple, manual deployment of a configuration profile for EAP-TLS Wi-Fi on Apple devices
---

## Introduction
This tutorial focuses on a simple, manual deployment of a configuration profile for EAP-TLS Wi-Fi on Apple devices
It's perfect for trying out EAP-TLS certificate-based Wi-Fi on a small number of Apple devices, if you don't have an MDM provider.

**If you use device management (MDM)**, find our MDM tutorials instead:
- [Deploying EAP-TLS Wi-Fi with Jamf Pro + Smallstep](/tutorials/apple-mdm-jamf-setup-guide.mdx)
- [Deploying EAP-TLS Wi-Fi with any Apple MDM + Smallstep](/tutorials/generic-apple-mdm-setup-guide.mdx)
...
- A test Apple device running macOS, iOS, or iPadOS
- A router that supports WPA2 or WPA3 Enterprise EAP-TLS Wi-Fi
...
### Configure your MDM to use Smallstep's SCEP server
