...
3. Add a new Script
    ...
    2. In the Script tab:
        ...
        - Content:
            ...
            /Applications/SmallstepAgent/Contents/MacOS/SmallstepAgent uninstall
            rm -rf /Applications/SmallstepAgent
...
Once the agent is uninstalled from all endpoints, remove the Policy and Script you created above.
