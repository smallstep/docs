...
- A [package distribution point](https://docs.jamf.com/10.35.0/jamf-pro/install-guide-linux/About_Distribution_Points.html) configured in Jamf Pro
...
In this step, we’ll tie everything together by configuring Jamf to distribte the Smallstep Agent.
