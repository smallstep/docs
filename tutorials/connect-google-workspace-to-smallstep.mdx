...
2. Go to [Chrome Verified Access API](https://console.cloud.google.com/marketplace/product/google/verifiedaccess.googleapis.com) for your project, and choose **Enable API**
...
14. Scroll down in the side panel details, and confirm the **Installation URL** field shows the URL you set in step 7.
