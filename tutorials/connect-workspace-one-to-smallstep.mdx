...
**Note:** if you don't want to use Workspace ONE UEM to install the agent, see the [Smallstep Agent Manual Installation](../platform/smallstep-agent.mdx#windows-installation) guide.
...
1. In Workspace One UEM,
    ...
    5. Under General, Provide a name (for example, "Smallstep Device Enrollment")
