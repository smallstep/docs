...
- **Jamf Settings**: A Jamf webhook URL, username and password to be used when configuring your Jamf webhook
- **Configuration Profile** template: The `.mobileconfig` file you downloaded

### Configure Jamf to use Smallstep

There are three steps to this part of the process:

1. Configure a SCEP dynamic challenge webhook in Jamf
2. Upload the Configuration Profile you downloaded from Smallstep
3. Complete and test your setup
