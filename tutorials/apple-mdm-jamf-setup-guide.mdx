...
html_title: Deploy EAP-TLS Wi-Fi certificates to Apple devices with Smallstep and Jamf Pro
description: This tutorial focuses on deploying client certificates for use with EAP-TLS to your devices via Jamf Pro and your Smallstep Authority.
---
