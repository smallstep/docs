...
That's it. You now have automated, short-lived certificates for your Kubernetes cluster. [Many use cases](https://cert-manager.io/docs/usage/) exist for X.509 certificates issued through cert-manager.
